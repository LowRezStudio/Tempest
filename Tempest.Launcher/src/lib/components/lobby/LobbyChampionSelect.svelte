...
<div class="relative flex h-full w-full flex-col overflow-hidden">
	...
	<div class="relative flex-1 overflow-hidden">
		...
		<div
			class="absolute top-0 bottom-0 left-0 z-20 flex w-48 flex-col gap-3 bg-gradient-to-r from-blue-950/95 via-blue-900/40 to-transparent p-4 pt-6 md:w-64 md:p-6 lg:w-80"
		>
		...
		<div
			class="absolute top-0 right-0 bottom-0 z-20 flex w-48 flex-col gap-3 bg-gradient-to-l from-red-950/95 via-red-900/40 to-transparent p-4 pt-6 md:w-64 md:p-6 lg:w-80"
		>
