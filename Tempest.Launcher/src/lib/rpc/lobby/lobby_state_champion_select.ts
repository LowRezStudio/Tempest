...
// @generated from protobuf file "lobby/lobby_state_champion_select.proto" (package "tempest.lobby", syntax proto3)
// tslint:disable
...
class LobbyStateChampionSelect$Type extends MessageType<LobbyStateChampionSelect> {
	...
	internalBinaryRead(
		...
		target?: LobbyStateChampionSelect,
	): LobbyStateChampionSelect {
	...
	internalBinaryWrite(
		message: LobbyStateChampionSelect,
...
/**
 * @generated MessageType for protobuf message tempest.lobby.LobbyStateChampionSelect
 */
export const LobbyStateChampionSelect = new LobbyStateChampionSelect$Type();
