...
// @generated from protobuf file "lobby/leave_lobby_response.proto" (package "tempest.lobby", syntax proto3)
// tslint:disable
...
class LeaveLobbyResponse$Type extends MessageType<LeaveLobbyResponse> {
	constructor() {
		super("tempest.lobby.LeaveLobbyResponse", []);
	}
...
/**
 * @generated MessageType for protobuf message tempest.lobby.LeaveLobbyResponse
 */
